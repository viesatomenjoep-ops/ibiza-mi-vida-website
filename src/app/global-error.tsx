      ...
      <body style={{ margin: 0, background: '#0B0C10', color: '#fff', fontFamily: 'sans-serif' }}>
        <div style={{ display: 'flex', minHeight: '100vh', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 24px', textAlign: 'center' }}>
          ...
          <button
            type="button"
            onClick={() => reset()}
            style={{ marginTop: 32, borderRadius: 999, background: '#000', color: '#fff', border: 'none', padding: '14px 28px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: 12, cursor: 'pointer' }}
          >
            Try again
          </button>
        </div>
