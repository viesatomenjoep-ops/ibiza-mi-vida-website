...
export default function YachtsCruisesPage() {
  return (
    <>
      <link
  rel="preload"
...
<link
  rel="preload"
  as="image"
  href="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-portrait.svg"
/><link
  rel="preload"
  as="image"
  href="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-landscape.svg"
...
<section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
  <div className="container">
    ...
    <div className="grid grid-cols-1 gap-6 md:gap-8">
      ...
      >
        <div
          className="grid grid-cols-1 border border-border-primary sm:col-span-2 sm:row-span-1 sm:grid-cols-2"
        >
          <div
        ...
        <div className="flex flex-col border border-border-primary">
          <div className="flex flex-col justify-center p-6">
            <div>
              <p className="mb-2 text-sm font-semibold">Concierge</p>
              <h3 className="mb-2 text-xl font-bold md:text-2xl">On demand</h3>
              <p>Your dedicated team handles every detail.</p>
            </div>
  ...
  <div className="container">
    ...
    >
      ...
      >
        ...
        <p className="md:text-md">
          &quot;The yacht was immaculate, the crew knew every detail before we
          asked, and the sunset was exactly as promised. This is how luxury
          should feel.&quot;
        </p>
        <div
