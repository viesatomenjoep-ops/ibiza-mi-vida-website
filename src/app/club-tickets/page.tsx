      ...
      <section id="clubs" className="px-[5%] py-16 bg-gray-50">
        <div className="container mx-auto">
          <div className="mb-12 text-center max-w-2xl mx-auto">
            <h2 className="mb-4 text-4xl font-serif font-bold md:text-5xl">Discover The Best Clubs</h2>
            <p className="text-gray-600">Select your favorite club to view the current schedule, line-ups, and ticket prices.</p>
          </div>
