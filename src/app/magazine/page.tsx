    ...
    <div className="flex flex-col justify-start">
      <div className="md:min-w- mb-10">
        <button
          ...
          dir="ltr"
          data-state="closed"
          className="flex min-h-11 w-full items-center justify-between gap-1 whitespace-nowrap border border-border-primary bg-transparent text-text-primary focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&amp;&gt;span]:line-clamp-1 [&amp;[data-state=open]&gt;svg]:rotate-180 min-w-[12.5rem] px-4 py-2 md:w-auto"
        >
          All Posts<svg
            stroke="currentColor"
            fill="none"
      ...
      <div style={{ "opacity": 0 } as React.CSSProperties}>
        <div
         
          className="grid grid-cols-1 gap-x-12 gap-y-12 md:gap-y-16"
        >
          <div className="flex flex-col border border-border-primary">
            <a href="#" className="inline-block w-full max-w-full overflow-hidden"
