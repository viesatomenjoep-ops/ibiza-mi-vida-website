      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 md:mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          {fullEvent?.requirements && (
            <div className="bg-red-950/20 border border-red-500/20 rounded-3xl p-6 md:p-8">
              <h2 className="text-xl font-bold text-red-400 mb-2">Important Information</h2>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 bg-[#141414] border border-[#00A698]/30 rounded-3xl p-6 md:p-8 shadow-2xl shadow-[#00A698]/5">
              ...
              <div className="flex flex-col border-2 border-[#00A698] bg-[#00A698]/5 rounded-2xl p-4 cursor-pointer relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-2">
                  <div className="flex flex-col">
                    <span className="font-bold text-lg text-white">Standard Entry</span>
                    <span className="text-xs text-white/50">Official general admission</span>
                  </div>
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="font-black text-3xl">€{(priceNum * ticketCount).toFixed(2)}</span>
            </div>
            ...
            <p className="text-center text-[11px] text-white/40 mt-3 flex items-center justify-center gap-1">
