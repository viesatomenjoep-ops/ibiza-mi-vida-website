    ...
    >
      <div className="relative p-6 md:p-8">
        ...
        <div className="relative z-10">
          ...
          <h3
            className="mb-3 text-2xl font-bold text-text-alternative md:mb-4 md:text-3xl md:leading-[1.3] lg:text-4xl"
          >
  ...
  <div className="container">
    ...
    >
      ...
      >
        ...
        <p className="md:text-md">
          &quot;The speedboat tour changed everything. We found places that
          don&#x27;t exist on any map.&quot;
        </p>
        <div
