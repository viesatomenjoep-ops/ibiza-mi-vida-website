...
export default async function VipCatamaranPage() {
  ...
  return (
    <>
      ...
      {/* Inclusions */}
      <section className="bg-ibiza-sand/90 backdrop-blur-md py-12 md:py-16 relative z-20 -mt-16 md:-mt-24 rounded-3xl border border-white/50 shadow-xl mx-4 md:mx-8 mb-8">
