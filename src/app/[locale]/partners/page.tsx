...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return staticMetadata(params.locale, 'partners', 'Partners')
}
...
<section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
  <div className="container max-w-lg">
    <div
      ...
      className="rb-12 mb-12 text-center md:mb-18 lg:mb-20"
    >
      <h2
    ...
    >
      <div
        data-state="closed"
        data-orientation="vertical"
        className="first:border-t border border-border-primary px-5 md:px-6"
       
      >
        <h3 data-orientation="vertical" data-state="closed" className="flex w-full">
          <button
            type="button"
            ...
            data-orientation="vertical"
            id="radix-«R6»"
            className="flex flex-1 items-center justify-between py-4 font-bold transition-all focus-visible:outline-none focus-visible:ring-0 md:py-5 md:text-md [&amp;[data-state=open]&gt;svg]:rotate-45"
            data-radix-collection-item=""
          >
            Question text goes here<svg
              stroke="currentColor"
              fill="none"
              strokeWidth="0"
              viewBox="0 0 15 15"
    ...
    >
      <div>
        ...
        <p className="mb-5 md:mb-6">
          Send us your inquiry and we&#x27;ll schedule a call
        </p>
      ...
      <div>
        ...
        <p className="mb-5 md:mb-6">
          Fastest way to reach our team for immediate questions
        </p>
        <a className="underline" href="#">Message us now</a>
      </div>
      <div>
        <div className="rb-5 mb-5 md:mb-6">
          <svg
        ...
        <p className="mb-5 md:mb-6">Speak directly with our partnership director</p>
        <a className="underline" href="#">+34 971 123 456</a>
      </div>
      <div>
        <div className="rb-5 mb-5 md:mb-6">
          <svg
        ...
        <p className="mb-5 md:mb-6">Visit us in the heart of Ibiza Town</p>
        <a className="underline" href="#"
          >Calle de la Virgen 42, Ibiza 07800 Spain</a
        >
      </div>
    </div>
  </div>
