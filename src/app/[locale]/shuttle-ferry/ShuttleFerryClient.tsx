...
export default function ShuttleFerryClient({ locale = 'nl' }: { locale: string }) {
      ...
      <div className="pl-header">
        <div className="pl-header-inner">
          ...
          <div style={{width:'100%', marginTop: '16px'}}>
            ...
            <h1 className="pl-title">Shuttle Ferry</h1>
        ...
        <div className="pl-tabs" style={{marginTop: '24px'}}>
          <button className="pl-tab active">⛴️ Shuttle Ferry</button>
        </div>
      </div>
