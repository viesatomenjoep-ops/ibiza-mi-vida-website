...
export default function GuestlistClient({ locale = 'nl' }: { locale: string }) {
      ...
      <div className="pl-header">
        <div className="pl-header-inner">
          ...
          <div style={{width:'100%', marginTop: '16px'}}>
            <span className="pl-eyebrow">VIP Insider</span>
            <h1 className="pl-title">Gastenlijst</h1>
        ...
        <div className="pl-tabs" style={{marginTop: '24px'}}>
          <button className="pl-tab active">VIP Gastenlijst</button>
        </div>
      </div>
