...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return staticMetadata(params.locale, 'careers', 'Careers')
}
...
<section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
  <div className="container max-w-lg text-center">
    ...
    <p
      ...
      className="mb-5 text-lg font-bold leading-[1.4] md:mb-6 md:text-2xl"
    >
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
  ...
  <div className="mx-auto max-w-lg">
    ...
    <div className="" data-orientation="vertical">
      <div
        ...
        className="border-b border-border-primary first:border-t-0"
      >
        <h3 data-orientation="vertical" data-state="closed" className="flex w-full">
          <button
            ...
            data-orientation="vertical"
            id="radix-«Rm»"
            className="flex flex-1 items-center justify-between py-4 font-bold transition-all focus-visible:outline-none focus-visible:ring-0 [&amp;[data-state=open]&gt;svg]:rotate-180 text-2xl md:py-5 md:text-3xl md:leading-[1.3] lg:text-4xl"
