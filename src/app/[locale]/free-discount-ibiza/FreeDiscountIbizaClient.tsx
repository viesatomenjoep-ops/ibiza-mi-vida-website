...
export default function FreeDiscountIbizaClient({ locale = 'nl' }: { locale: string }) {
      ...
      <div className="pl-header">
        <div className="pl-header-inner">
          ...
          <div style={{width:'100%', marginTop: '16px'}}>
            <span className="pl-eyebrow">🏷️ Insider</span>
            <h1 className="pl-title">Free & Discount Ibiza</h1>
        ...
        <div className="pl-tabs" style={{marginTop: '24px'}}>
          <button className="pl-tab active">🏷️ Free & Discount Ibiza</button>
        </div>
      </div>
