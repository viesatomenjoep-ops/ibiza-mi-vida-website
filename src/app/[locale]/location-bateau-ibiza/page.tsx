...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Location de bateau à Ibiza',
    description:
      'Louer un bateau à Ibiza avec skipper, avec votre permis ou sans permis jusqu’à 15 ch. Quatre ports de départ et les routes vers Es Vedrà et Formentera.',
    alternates: localizedAlternates('boat-rental', LOCALE),
    openGraph: {
      type: 'website', siteName: SITE_NAME,
      title: 'Location de bateau à Ibiza',
      description: 'Louer un bateau à Ibiza avec skipper, avec votre permis ou sans permis jusqu’à 15 ch.',
      locale: 'fr_FR',
      images: [{ url: '/og-default.jpg', width: 1200, height: 630, alt: 'Location de bateau à Ibiza' }],
    },
  }
}
...
const CRUMBS: Crumb[] = [
  { name: 'Accueil', path: '' },
  { name: 'Bateaux', path: 'boats' },
  { name: 'Location de bateau Ibiza' },
]
...
export default function LocationBateauIbizaPage() {
  return (
    <>
      <SchemaMarkup locale={LOCALE} breadcrumbs={CRUMBS} faqs={FAQS} product={{
        ...
        brand: 'Click&Boat', price: skipper, path: 'location-bateau-ibiza',
      }} />
