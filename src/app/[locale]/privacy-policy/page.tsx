...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return staticMetadata(params.locale, 'privacy-policy', 'Privacy Policy', true)
}
...
<section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
  <div className="container">
    <div
      className="grid grid-cols-1 gap-y-8 lg:grid-cols-[1fr_20rem] lg:gap-x-16 xxl:gap-x-48"
    >
        ...
        <div className="prose md:prose-md lg:prose-lg">
          ...
          <p>
            <strong
              ...
              vitae malesuada fringilla.</strong
            >
          </p>
          <p>
          ...
          <h3 id="heading-3">How we use your data</h3>
          <p>
          ...
          <h4 id="heading-4">Data protection and security</h4>
          <p>
          ...
          <h5 id="heading-5">Cookies and tracking</h5>
          <p>
            Morbi sed imperdiet in ipsum, adipiscing elit dui lectus. Tellus id
            scelerisque est ultricies ultricies. Duis est sit sed leo nisl,
            blandit elit sagittis. Quisque tristique consequat quam sed. Nisl at
          ...
          <h6 id="heading-5">Your rights and choices</h6>
          <p>
      ...
      <div className="order-first lg:order-none">
        <div className="lg:sticky lg:top-24">
          <div className="lg:block" data-orientation="vertical">
            <div
              data-state="open"
              data-orientation="vertical"
              className="border-b border-border-primary first:border-t border-none"
            >
              <h3
                data-orientation="vertical"
                data-state="open"
              ...
              >
                <button
                  ...
                  data-orientation="vertical"
                  id="radix-«R2»"
                  className="flex-1 font-bold transition-all focus-visible:outline-none focus-visible:ring-0 [&amp;[data-state=open]&gt;svg]:rotate-180 flex cursor-pointer items-center justify-between gap-3 border border-border-primary px-4 py-3 lg:pointer-events-none lg:cursor-auto lg:border-none lg:p-0 [&amp;_svg]:size-4 [&amp;_svg]:lg:hidden"
              ...
              <div
                ...
                style={{ "--radix-accordion-content-height": "var(--radix-collapsible-content-height)", "--radix-accordion-content-width": "var(--radix-collapsible-content-width)" } as React.CSSProperties}
              >
                <div className="pb-5">
                  <div className="mt-3 md:mt-4">
                    <a
                      ...
                      style={{ "marginLeft": 0 } as React.CSSProperties}
                      >Information we collect</a
                    ><a
                      href="#heading-3"
                      className="block px-4 py-3 md:text-md"
                      style={{ "marginLeft": "16px" } as React.CSSProperties}
                      >How we use your data</a
                    ><a
                      href="#heading-4"
                      className="block px-4 py-3 md:text-md"
                      style={{ "marginLeft": "32px" } as React.CSSProperties}
                      >Data protection and security</a
                    ><a
                      href="#heading-5"
                      className="block px-4 py-3 md:text-md"
                      style={{ "marginLeft": "48px" } as React.CSSProperties}
                      >Cookies and tracking</a
                    ><a
                      href="#heading-6"
                      className="block px-4 py-3 md:text-md"
                      style={{ "marginLeft": "64px" } as React.CSSProperties}
