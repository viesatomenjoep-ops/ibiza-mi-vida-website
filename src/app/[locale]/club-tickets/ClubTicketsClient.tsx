...
export default function ClubTicketsClient({ 
  ...
  return (
    <div className="theme-monaco-vip bg-neutral-50 text-[var(--color-ink)] min-h-screen relative overflow-hidden">
      <section className="pt-[calc(var(--nav-h)+12px)] pb-4 relative z-10 flex flex-col items-center text-center px-4">
                  ...
                  return (
                    <div key={v.slug} className="flex flex-col items-center justify-center shrink-0">
                      ...
                      >
                        {v.logo ? (
                          <img
                            src={optImg(v.logo, 120)} loading="lazy"
                            alt={v.name}
                  ...
                  <div className="media">
                    ...
                    <div className="ph">
                      {event.eventCover || event.eventLogo || event.venueCover ? (
                         <img src={optImg(event.eventCover || event.eventLogo || event.venueCover, 500)} loading="lazy" alt={event.eventName || event.name} style={{ width: '100%', height: '100%', objectFit: 'cover', position: 'relative', zIndex: 0 }} />
                      ) : (
      ...
      <section className="block alt">
        <div className="wrap">
          <div className="wa-band">
            ...
            <a className="wa-big" href="https://wa.me/34657639800" target="_blank" rel="noreferrer">
