...
export function EventCheckoutClient({ selectedDateObj, allEventDates, fullEvent, locale }: Props) {
  ...
  const imageUrl = selectedDateObj.eventCover || selectedDateObj.eventLogo || selectedDateObj.venueCover || selectedDateObj.venueLogo || '/hi-ibiza-2026/FB_IMG_1779623220486.jpg'
    ...
    <div className="theme-monaco-vip bg-[var(--color-paper)] text-[var(--color-ink)] min-h-screen pt-20 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 md:mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          {selectedDateObj.lineUp && (
            <div className="bg-white border border-black/5 rounded-3xl p-6 md:p-8 shadow-sm">
              <h2 className="text-2xl font-serif font-bold mb-4 flex items-center gap-3 text-velvet-obsidian">
                <div className="w-10 h-10 rounded-xl bg-ibiza-mint flex items-center justify-center shrink-0">
                  <Ticket size={20} className="text-velvet-obsidian" />
                </div>
                Line Up
              </h2>
              <p className="text-velvet-obsidian/80 leading-relaxed text-lg font-medium">
                {selectedDateObj.lineUp}
              </p>
            </div>
          )}
          ...
          {fullEvent?.description && (
            <div className="bg-white border border-black/5 rounded-3xl p-6 md:p-8 shadow-sm">
              ...
              <div className="prose prose-lg max-w-none text-velvet-obsidian/80 font-medium">
          ...
          {fullEvent?.requirements && (
            <div className="bg-red-50 border border-red-100 rounded-3xl p-6 md:p-8 shadow-sm">
              <h2 className="text-xl font-bold text-red-600 mb-4">Important Information</h2>
              <div 
                className="text-red-900/80 font-medium text-sm md:text-base prose prose-sm max-w-none prose-p:my-1 prose-ul:my-1" 
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 bg-white border border-black/5 rounded-3xl p-6 md:p-8 shadow-xl">
            ...
            <div className="flex flex-col gap-4 mb-8">
              ...
              <div className="flex flex-col border-2 border-ibiza-green bg-ibiza-green/10 rounded-2xl p-5 cursor-pointer relative overflow-hidden transition-all hover:bg-ibiza-green/20">
                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-black/5">
                  ...
                  <div className="flex items-center gap-3 bg-white rounded-xl p-1 border border-black/5 shadow-sm">
                    <button 
                      className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-ibiza-mint transition-colors text-xl font-bold text-velvet-obsidian"
            ...
            {/* Total */}
            <div className="flex justify-between items-center mb-8 bg-ibiza-sand/50 p-4 rounded-2xl">
            ...
            <button 
              ...
              className="w-full bg-ibiza-green hover:brightness-95 text-velvet-obsidian font-bold text-lg py-5 rounded-2xl flex items-center justify-center gap-2 transition-all shadow-lg hover:scale-[1.02]"
            >
