...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Alquiler de barco en Ibiza, con o sin título',
    description:
      'Alquiler de barco en Ibiza con patrón, con tu titulación o sin ella hasta 15 CV. Cuatro puertos de salida, rutas a Es Vedrà y Formentera, y precios.',
    alternates: localizedAlternates('boat-rental', LOCALE),
    openGraph: {
      type: 'website', siteName: SITE_NAME,
      title: 'Alquiler de barco en Ibiza, con o sin título',
      description: 'Alquiler de barco en Ibiza con patrón, con tu titulación o sin ella hasta 15 CV.',
      locale: 'es_ES',
      images: [{ url: '/og-default.jpg', width: 1200, height: 630, alt: 'Alquiler de barco en Ibiza' }],
    },
  }
}
...
export default function AlquilerBarcoIbizaPage() {
  return (
    <>
      <SchemaMarkup locale={LOCALE} breadcrumbs={CRUMBS} faqs={FAQS} product={{
        ...
        brand: 'Click&Boat', price: patron, path: 'alquiler-barco-ibiza',
      }} />
