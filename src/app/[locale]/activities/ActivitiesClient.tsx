...
export default function ActivitiesClient({ locale = 'nl' }: { locale: string }) {
      ...
      <div className="pl-header">
        <div className="pl-header-inner">
          ...
          <div style={{width:'100%', marginTop: '16px'}}>
            <span className="pl-eyebrow">🏎️ Beleef het Eiland</span>
            <h1 className="pl-title">Activities & Buggies</h1>
        ...
        <div className="pl-tabs" style={{marginTop: '24px'}}>
          <button className="pl-tab active">🏎️ Activities & Buggies</button>
        </div>
      </div>
