...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Boot huren op Ibiza zonder vaarbewijs',
    description:
      'Boot huren op Ibiza met schipper, met eigen vaarbewijs of zonder vaarbewijs tot 15 pk. Vier jachthavens, en de routes langs Es Vedrà en Formentera.',
    alternates: localizedAlternates('boat-rental', LOCALE),
    openGraph: {
      type: 'website',
      siteName: SITE_NAME,
      title: 'Boot huren op Ibiza zonder vaarbewijs',
      description: 'Boot huren op Ibiza met schipper, met eigen vaarbewijs of zonder vaarbewijs tot 15 pk.',
      locale: 'nl_NL',
      images: [{ url: '/og-default.jpg', width: 1200, height: 630, alt: 'Boot huren op Ibiza' }],
    },
  }
}
...
const CRUMBS: Crumb[] = [
  { name: 'Home', path: '' },
  { name: 'Boten', path: 'boats' },
  { name: 'Boot huren Ibiza' },
]
...
export default function BootHurenIbizaPage() {
  return (
    <>
      <SchemaMarkup
        locale={LOCALE}
