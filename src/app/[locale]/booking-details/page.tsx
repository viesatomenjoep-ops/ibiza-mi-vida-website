    ...
    <div className="grid grid-cols-1 gap-6 md:gap-8">
      ...
      >
        <div
          ...
          className="flex flex-col items-stretch border border-border-primary sm:col-span-2 sm:row-span-2"
        >
          <div
           
           
            className="flex flex-1 flex-col justify-center p-6 md:p-8 lg:p-12"
          >
            <div
        ...
        <div className="flex flex-col border border-border-primary">
          <div className="flex h-full flex-col justify-between p-6 md:p-8 lg:p-6">
            <div>
              ...
              <p>Tonight from 23:00 with priority entry access.</p>
            </div>
...
<section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
  <div className="container flex flex-col items-center">
    <div
      ...
      className="mb-12 max-w-lg text-center md:mb-18 lg:mb-20"
    >
      <h2
      ...
      <div
        ...
        className="mx-auto mt-6 w-full max-w-sm md:mt-8"
      >
        <form
