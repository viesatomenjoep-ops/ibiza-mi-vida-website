...
export async function generateMetadata({ params }: { params: { slug: string; locale: string } }): Promise<Metadata> {
  ...
  if (!venue) return staticMetadata(params.locale, 'water-sports')
  return detailMetadata(params.locale, `water-sports/${params.slug}`, venue.name, {
...
export default async function DetailPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <VenueNextStep locale={params.locale as any} typeSlug="activities" currentSlug={params.slug} />
    </>
  )
}