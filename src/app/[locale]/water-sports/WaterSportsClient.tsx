...
export default function WaterSportsClient({ locale = 'nl' }: { locale: string }) {
      ...
      <div className="pl-header">
        <div className="pl-header-inner">
          ...
          <div style={{width:"100%"}}>
            ...
            <h1 className="pl-title">Water Sports</h1>
        ...
        <div className="pl-tabs" style={{marginTop: '24px'}}>
          <button className="pl-tab active">🏄 Water Sports</button>
        </div>
      </div>
