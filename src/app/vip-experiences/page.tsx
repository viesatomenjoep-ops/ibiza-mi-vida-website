...
<section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
  <div className="container">
    ...
    >
      <div>
        <p className="mb-3 font-semibold md:mb-4">Curated</p>
        <h3 className="text-5xl font-bold leading-[1.2] md:text-7xl lg:text-8xl">
          Private tables, yachts and unlisted experiences
        </h3>
      </div>
      <div>
        <p className="mb-6 md:mb-8 md:text-md">
          Beyond velvet ropes. For those who expect the extraordinary.
        </p>
        <div className="grid grid-cols-1 gap-6 py-2 sm:grid-cols-2">
          <div>
            ...
            <p>Personalized itineraries built by our concierge team</p>
          </div>
          <div>
            <h3 className="mb-2 text-5xl font-bold md:text-7xl lg:text-8xl">
              24/7
            </h3>
            <p>Direct access to unlisted tables and private charters</p>
          </div>
        </div>
  ...
  <div className="container">
    <div className="mb-12 md:mb-18 lg:mb-20">
      <div className="mx-auto max-w-lg text-center">
        ...
        <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
          Experiences money cannot easily buy
        </h2>
        <p className="md:text-md">
          Access to private islands, closed-door dinners, and moments reserved
          for the few. Each experience curated by our team and available only
          through Ibizamivida.
        </p>
      </div>
    </div>
    <div dir="ltr" data-orientation="horizontal" className="">
      <div
        ...
        style={{ "animationDuration": "0s" } as React.CSSProperties}
      >
        <div>
          <img
            src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-landscape.svg"
      ...
      <div
        ...
        className="flex mt-12 flex-col md:mt-16 md:flex-row"
        tabIndex={-1}
        data-orientation="horizontal"
      ...
      >
        <button
          ...
          className="items-center justify-center bg-background-primary text-text-primary transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 flex w-full flex-col gap-1 whitespace-normal border-0 border-t-[1.5px] border-border-alternative px-6 py-4 text-center duration-0 data-[state=active]:border-t-[1.5px] data-[state=active]:border-border-primary data-[state=active]:bg-transparent data-[state=active]:text-text-primary"
          tabIndex={-1}
          data-orientation="horizontal"
        ...
        ><button
          ...
          role="tab"
          aria-selected="false"
          aria-controls="radix-«R2»-content-tab-two"
          data-state="inactive"
          id="radix-«R2»-trigger-tab-two"
          className="items-center justify-center bg-background-primary text-text-primary transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 flex w-full flex-col gap-1 whitespace-normal border-0 border-t-[1.5px] border-border-alternative px-6 py-4 text-center duration-0 data-[state=active]:border-t-[1.5px] data-[state=active]:border-border-primary data-[state=active]:bg-transparent data-[state=active]:text-text-primary"
          tabIndex={-1}
          data-orientation="horizontal"
          data-radix-collection-item=""
        ...
        ><button
          ...
          role="tab"
          aria-selected="false"
          aria-controls="radix-«R2»-content-tab-three"
          data-state="inactive"
          id="radix-«R2»-trigger-tab-three"
          className="items-center justify-center bg-background-primary text-text-primary transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 flex w-full flex-col gap-1 whitespace-normal border-0 border-t-[1.5px] border-border-alternative px-6 py-4 text-center duration-0 data-[state=active]:border-t-[1.5px] data-[state=active]:border-border-primary data-[state=active]:bg-transparent data-[state=active]:text-text-primary"
          tabIndex={-1}
          data-orientation="horizontal"
          data-radix-collection-item=""
  ...
  <div className="container">
    ...
    >
      ...
      >
        ...
        <p className="md:text-md">
          &quot;Ibizamivida made the impossible happen. They understood what we
          wanted before we said it.&quot;
        </p>
        <div
