        ...
        <div className="relative z-10">
          <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
            ...
            >
              Select</button
            ><button
              className="focus-visible:ring-border-primary inline-flex items-center justify-center whitespace-nowrap ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-0 text-text-alternative gap-2 p-0"
            >
              Details<svg
                stroke="currentColor"
                fill="none"
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
        <div className="relative flex flex-col p-6 md:p-8 lg:p-6">
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-between">
            ...
            <h3
              className="mb-2 text-xl font-bold text-text-alternative md:text-2xl"
            >
              Pacha Ibiza
            </h3>
            <p className="text-text-alternative">House, Disco</p>
        ...
        <div className="relative flex flex-col p-6 md:p-8 lg:p-6">
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-between">
            ...
            <p className="text-text-alternative">Techno, House</p>
            <div className="mt-5 flex items-center md:mt-6">
              <button
                className="focus-visible:ring-border-primary inline-flex items-center justify-center whitespace-nowrap ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-0 text-text-alternative gap-2 p-0"
              >
        ...
        <div className="relative flex flex-col p-6 md:p-8 lg:p-6">
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-between">
            ...
            <p className="text-text-alternative">House, Commercial</p>
            <div className="mt-5 flex items-center md:mt-6">
              <button
                className="focus-visible:ring-border-primary inline-flex items-center justify-center whitespace-nowrap ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-0 text-text-alternative gap-2 p-0"
              >
        ...
        <div className="relative flex flex-col p-6 md:p-8 lg:p-6">
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-between">
            ...
            <p className="text-text-alternative">House, Techno</p>
            <div className="mt-5 flex items-center md:mt-6">
              <button
                className="focus-visible:ring-border-primary inline-flex items-center justify-center whitespace-nowrap ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-0 text-text-alternative gap-2 p-0"
              >
  ...
  <div className="container">
    ...
    >
      ...
      >
        ...
        <p className="md:text-md">
          &quot;The energy at Amnesia was unlike anything I&#x27;ve experienced.
          Every moment felt deliberate, perfect.&quot;
        </p>
        <div
        ...
        >
          ...
          <div>
            <p className="font-semibold">Marco V</p>
            <p>Amnesia VIP guest</p>
          </div>
        </div>
      </div>
      <div
