  ...
  const renderTile = (ds: string, i: number) => {
    ...
    return (
      ...
      >
        ...
        {variant === 'photo' && photoBg && <img src={optImg(photoBg, 128)} loading="lazy" decoding="async" alt="" className={`absolute inset-0 h-full w-full object-cover ${photoDim ? 'scale-110 blur-[2px]' : ''}`} />}
