/**
 * Bootverhuurgids (en) — de inhoud van de vroegere pillar /boat-rental-ibiza.
 *
...
import { HubHero, ChoiceCards, PriceTable, ItemGrid, ProseSection, InternalLinks } from '@/components/hub/HubSections'
