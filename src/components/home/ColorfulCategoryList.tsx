...
const allCategories = [
  { label: 'Deals of the Day', href: '/deals-of-the-day', icon: Star, desc: 'Best daily offers & events', color: 'bg-[#7086F8]' },
  { label: 'Private Boat Charters', href: '/private-boat-charters', icon: Anchor, desc: 'Yachts & exclusive rentals', color: 'bg-[#89F4C7]' },
  { label: 'Club Tickets', href: '/club-tickets', icon: Ticket, desc: 'Pacha, Amnesia, Hi Ibiza', color: 'bg-[#F8B5E5]' },
  { label: 'Boat Parties', href: '/boat-parties', icon: Music, desc: 'Sunset cruises & music', color: 'bg-[#F6FE80]' },
  { label: 'VIP Catamaran', href: '/vip-catamaran', icon: Navigation, desc: 'Luxury sailing experiences', color: 'bg-[#7086F8]' },
  { label: 'Formentera Trips', href: '/formentera-boat-trips', icon: Sun, desc: 'Day trips to paradise', color: 'bg-[#89F4C7]' },
  { label: 'Guestlist', href: '/guestlist', icon: CheckCircle, desc: 'Free entry & access', color: 'bg-[#F8B5E5]' },
  { label: 'Drink Packages', href: '/drink-packages', icon: GlassWater, desc: 'VIP tables & bottle service', color: 'bg-[#F6FE80]' },
  { label: 'Car & Scooter', href: '/car-scooter-rental', icon: Car, desc: 'Explore at your own pace', color: 'bg-[#7086F8]' },
]
  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-8">
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <Link href="/club-tickets" className="font-sans text-[16px] text-[#007AFF] font-medium cursor-pointer">See All</Link>
      </div>
