...
export function HomeSelectorDock({
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-[55] border-t border-black/10 bg-white/95 shadow-[0_-8px_30px_rgba(0,0,0,0.14)] backdrop-blur-md transition-transform duration-500 ease-out"
