...
export function HomeMapWidget({ locale = 'nl' }: { locale?: string }) {
  ...
  return (
    <section ref={secRef} id="ibiza-map-section" className="w-full bg-[#EFEDEA] pt-10 md:pt-14">
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        ...
        <button
          type="button"
          onClick={() => setOpen(o => !o)}
          className="absolute right-8 top-20 z-10 inline-flex items-center gap-2 rounded-full bg-[#1B1917] px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.16em] text-[#EFEDEA] shadow-lg transition-transform hover:-translate-y-0.5"
        >
