  ...
  return (
    <div className="mx-auto max-w-5xl flex flex-col gap-8 md:gap-10">
      ...
      <div className="bg-ibiza-sand rounded-[32px] overflow-hidden flex flex-col shadow-sm border border-black/5">
        ...
        {/* Banner */}
        <div className="bg-gradient-to-br from-velvet-obsidian to-black p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
          ...
          <div className="z-10 text-center md:text-left flex-1">
            <div className="mb-2 inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 font-sans text-xs font-semibold uppercase tracking-wider text-white backdrop-blur-md border border-white/20">
              <span className="h-1.5 w-1.5 rounded-full bg-green-400 shadow-[0_0_8px_rgba(74,222,128,0.8)] animate-pulse" />
              Live Offers
            </div>
            <h2 className="text-3xl md:text-5xl font-serif text-white mb-3">Deal of the Day</h2>
            <p className="text-white/70 font-sans text-sm md:text-base max-w-lg">The best hand-picked offers across all categories. Select the deals you want and book via WhatsApp before the timer runs out!</p>
          </div>
