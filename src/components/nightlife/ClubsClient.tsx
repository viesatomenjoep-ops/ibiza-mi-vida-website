              ...
              {suggestions.map(v => (
                ...
                >
                  <span className="grid h-9 w-9 shrink-0 place-items-center overflow-hidden rounded-lg bg-neutral-900">
                    {(v.whitelogo || v.cover || v.picture) ? <img src={optImg(v.whitelogo || v.cover || v.picture, 100)} loading="lazy" alt={`${v.name} logo`} className="max-h-full max-w-full object-contain" /> : null}
                  </span>
