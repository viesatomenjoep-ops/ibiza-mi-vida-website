    ...
    <div className="flex flex-col gap-5 pt-1">
      ...
      <div className="flex flex-col gap-2.5 rounded-2xl border border-white/[0.07] bg-obsidian-card p-4">
        <span className="flex items-center gap-2.5 text-[15px] font-semibold text-white/85">
          <MapPin size={16} className="shrink-0 text-gold-soft" /> {e.venueName}
        </span>
        <span className="flex items-center gap-2.5 text-[15px] font-semibold text-white/85">
          <Clock size={16} className="shrink-0 text-gold-soft" />
      ...
      {e.lineUp && (
        <div>
          ...
          <p className="flex items-start gap-2.5 rounded-2xl border border-white/[0.07] bg-obsidian-card p-4 text-[14px] leading-relaxed text-white/80">
            <Headphones size={16} className="mt-0.5 shrink-0 text-gold-soft" />
            <span>{e.lineUp}</span>
          </p>
        </div>
      )}
      ...
      <div className="mt-1 grid grid-cols-2 gap-3">
        <a
          ...
          className="flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/[0.06] px-4 py-3.5 text-[13px] font-extrabold uppercase tracking-wide text-white outline-none transition-colors motion-reduce:transition-none hover:bg-white/[0.12] focus-visible:ring-2 focus-visible:ring-gold-soft active:scale-[0.97] motion-reduce:active:scale-100"
        >
          <Martini size={16} className="shrink-0 text-gold-soft" /> {t.saveOnDrinks}
        </a>
        {e.affLink ? (
          <a
