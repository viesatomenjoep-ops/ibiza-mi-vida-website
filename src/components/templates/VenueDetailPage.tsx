        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr] gap-8 items-start">
            <div className="text-black text-lg leading-relaxed">
              ...
              <a href="https://wa.me/33666528412" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-ibiza-green text-white font-bold text-sm px-6 py-3 rounded-full hover:brightness-95 transition-all">
