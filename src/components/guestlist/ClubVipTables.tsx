...
const CLUBS_DATA = [
  ...
  {
    name: 'Club Chinois',
    type: L('Exclusieve boutique club in Ibiza Marina (23:30 – 05:00)', 'Exclusive boutique club in Ibiza Marina (23:30 – 05:00)', 'Exklusiver Boutique-Club in Ibiza Marina (23:30 – 05:00)', 'Club boutique exclusivo en Marina Ibiza (23:30 – 05:00)', 'Club boutique exclusif à Marina Ibiza (23:30 – 05:00)'),
    zones: L(
      'Main Room VIP Tables (rondom de dansvloer), DJ Mezzanine & Private Lounge Booths.',
      'Main Room VIP Tables (encircling the dance floor), DJ Mezzanine & Private Lounge Booths.',
      'Main Room VIP-Tische (rund um den Dancefloor), DJ Mezzanine & Private Lounge Booths.',
      'Mesas VIP de la Main Room (alrededor de la pista), DJ Mezzanine y reservados privados.',
      'Tables VIP de la Main Room (autour de la piste), mezzanine DJ & salons privés.',
    ),
    tip: L(
      'Verfijnd 1920s Shanghai-decor met intieme sfeer en uitmuntende service. Dresscode is hier stijlvol en strikter dan bij grote clubs.',
      'Decadent 1920s Shanghai glamour with an intimate atmosphere and exceptional table service. Dress code is stylish and strictly enforced.',
      'Elegantes 1920er-Jahre-Shanghai-Dekor mit intimer Atmosphäre und erstklassigem Service. Der Dresscode ist stilvoll und strikter.',
      'Elegante decoración estilo Shanghái de los años 20, ambiente exclusivo y servicio impecable. Código de vestimenta cuidado y estricto.',
      'Décor raffiné inspiré du Shanghai des années 20, ambiance intimiste et service d’exception. Dress code soigné et strictement appliqué.',
    ),
  },
  {
    name: 'Eden Ibiza',
    type: L('Superclub in San Antonio met Void Incubus soundsystem', 'Superclub in San Antonio with Void Incubus sound', 'Superclub in San Antonio mit Void-Soundsystem', 'Superclub en San Antonio con sonido Void', 'Superclub à San Antonio avec sound system Void'),
    zones: L(
      'Balcony VIP Boxes (verhoogd uitzicht over de main room), DJ Booth Tables & Mezzanine.',
      'Balcony VIP Boxes (elevated view over the main room), DJ Booth Tables & Mezzanine.',
      'VIP-Balkone (erhöhter Blick über den Main Room), DJ Booth Tables & Mezzanine.',
      'Palcos VIP en balcón (vista panorámica a la pista), mesas en cabina y mezzanine.',
      'Loges VIP en balcon (vue plongeante sur la salle), tables cabine DJ et mezzanine.',
    ),
    tip: L(
      'Uitstekende prijs-kwaliteitverhouding voor VIP-tafels met een van de krachtigste geluidssystemen van het eiland (o.a. Defected).',
      'Outstanding value for VIP tables, powered by one of the island’s most formidable sound systems (e.g. Defected).',
      'Hervorragendes Preis-Leistungs-Verhältnis für VIP-Tische mit einem der druckvollsten Soundsysteme der Insel (z.B. Defected).',
      'Excelente relación calidad-precio en mesas VIP con uno de los sistemas de sonido más potentes de la isla (ej. Defected).',
      'Excellent rapport qualité-prix pour les tables VIP avec l’un des meilleurs sound systems de l’île (notamment Defected).',
    ),
  },
  {
    name: 'O Beach Ibiza',
