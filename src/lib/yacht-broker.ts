...
// ibizaToday() woont in date-label.ts (neutraal, ook voor de agenda); hier
// alleen doorgegeven zodat bestaande imports blijven werken.
export { ibizaToday } from '@/lib/date-label'
